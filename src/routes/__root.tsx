  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "The Fat Bone Butcher — Honest Cuts. Deep Flavor." },
      {
        ...
        content: "High grade meat with great taste for every meal. 129 Fort Street, Bulawayo.",
      },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/logo-badge.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@FatBoneButcher" },
    ...
    links: [
      ...
      { rel: "alternate icon", href: "/favicon-32.png", type: "image/png" },
